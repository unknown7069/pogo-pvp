(function(global){
  ...
  const FAST_MOVES = Object.freeze([
    { id: 'quick_attack',  name: 'Quick Attack',  power: 40, energyGain: 8, attackRate: 3, type: 'normal',  rank: 2 },
    { id: 'dragon_breath', name: 'Dragon Breath', power: 30, energyGain: 9, attackRate: 2, type: 'dragon',  rank: 2 },
    { id: 'shadow_claw',   name: 'Shadow Claw',   power: 50, energyGain: 8, attackRate: 3, type: 'ghost',   rank: 3 },
    { id: 'counter',       name: 'Counter',       power: 60, energyGain: 8, attackRate: 4, type: 'fighting', rank: 3 },
    { id: 'vine_whip',     name: 'Vine Whip',     power: 45, energyGain: 7, attackRate: 2, type: 'grass',   rank: 2 },
    { id: 'ember',         name: 'Ember',         power: 40, energyGain: 7, attackRate: 2, type: 'fire',    rank: 2 },
    { id: 'water_gun',     name: 'Water Gun',     power: 40, energyGain: 8, attackRate: 2, type: 'water',   rank: 2 },
  ]);
  ...
  // NOTE: chargeUpTime is expressed in units of 500ms (i.e., 1 = 500ms).
  const CHARGED_MOVES = Object.freeze([
    { id: 'aqua_tail',    name: 'Aqua Tail',    power: 50, energyCost: 35, chargeUpTime: 3, specialEffects: 'none', type: 'water',  rank: 1 },
    { id: 'body_slam',    name: 'Body Slam',    power: 60, energyCost: 35, chargeUpTime: 2, specialEffects: 'none', type: 'normal', rank: 2 },
    { id: 'rock_slide',   name: 'Rock Slide',   power: 75, energyCost: 45, chargeUpTime: 3, specialEffects: 'none', type: 'rock',   rank: 2 },
    { id: 'shadow_ball',  name: 'Shadow Ball',  power: 100, energyCost: 55, chargeUpTime: 3, specialEffects: 'none', type: 'ghost',  rank: 3 },
    { id: 'hydro_cannon', name: 'Hydro Cannon', power: 90, energyCost: 50, chargeUpTime: 3, specialEffects: 'none', type: 'water',  rank: 3 },
    { id: 'hydro_pump',   name: 'Hydro Pump',   power: 130, energyCost: 75, chargeUpTime: 5, specialEffects: 'none', type: 'water',  rank: 3 },
    { id: 'flamethrower', name: 'Flamethrower', power: 90, energyCost: 55, chargeUpTime: 3, specialEffects: 'none', type: 'fire',   rank: 3 },
    { id: 'sludge_bomb',  name: 'Sludge Bomb',  power: 80, energyCost: 50, chargeUpTime: 3, specialEffects: 'none', type: 'poison', rank: 2 },
    { id: 'power_whip',   name: 'Power Whip',   power: 90, energyCost: 50, chargeUpTime: 3, specialEffects: 'none', type: 'grass',  rank: 3 },
    { id: 'water_pulse',  name: 'Water Pulse',  power: 70, energyCost: 60, chargeUpTime: 4, specialEffects: 'none', type: 'water',  rank: 1 },
  ]);
